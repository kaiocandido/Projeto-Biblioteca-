...
<body class="bg-gray-900 text-white min-h-screen">
  ...
  <?php
    ...
    require '../Projeto-Biblioteca-/Desktop/Biblioteca/processamento/autor_processamento.php'
  ?>
  ...
  <main class="p-6 max-w-3xl mx-auto">
    ...
    <?php
        ...
        ?>
    <!-- Botão Voltar -->
    <a href="lista_autores.php" class="inline-block mb-4 bg-gray-700 hover:bg-gray-800 px-4 py-2 rounded text-white">← Voltar</a>

    <!-- Formulário de cadastro de autor -->
    <form method="POST" class="bg-gray-800 p-6 rounded-lg shadow-md space-y-4" >
      <!-- Nome do Autor -->
      <div>
        <label class="block text-sm font-semibold mb-1" for="nome_autor">Nome do Autor</label>
        <input id="nome_autor" name="nome_autor" type="text" class="w-full p-2 rounded bg-gray-700 text-white border border-gray-600" required placeholder="Digite o nome do autor" maxlength="100"
        value="<?= $nome_autor ??  '' ?>">
      </div>
      <!-- Botão Salvar -->
